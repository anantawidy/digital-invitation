  ...
  return (
    <section id="gift" className="py-16 px-4 md:py-20 md:px-8 bg-transparent">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="font-serif text-3xl md:text-5xl text-gold mb-4">Wedding Gift</h2>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="w-full md:w-1/2 bg-card-bg p-6 md:p-8 rounded-lg shadow-sm backdrop-blur-sm border border-gold/50">
                ...
                <p className="text-sm md:text-base text-seashell mb-6">Untuk menghindari hadiah yang sama, silakan cek daftar hadiah yang sudah diberikan atau yang ingin diberikan.</p>
                <a 
